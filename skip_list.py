...
class SkipList:
    ...
    def increment_borders(self):
        ...
        self.root.colors.append("blue")
        self.end.colors.append("blue")
    ...
    def find(self, value, graph_list):
        ...
        tmp_graph = wd.SkipListGraph()
        tmp.colors[search_level] = "red"  # Set the current node to red
        graph_list.append(tmp_graph.create_graph(self))  # Append it to the list of graphs
        tmp.colors[search_level] = "blue"  # Reset the color to blue
        while True:
            while value >= tmp.list[search_level].value:  # The next Skip Node
                tmp.list[search_level].colors[search_level] = "red" # Set the current node to red
                graph_list.append(tmp_graph.create_graph(self)) # Append it to the list of graphs
                tmp.list[search_level].colors[search_level] = "blue" # Reset the color to blue
